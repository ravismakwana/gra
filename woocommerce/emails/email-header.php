                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="800" id="template_header">
                                        <tr>
                                            ...
                                            <td id="header_wrapper" style="padding: 10px 30px 10px 0;display: block;text-align: right;">
												...
												<p>
													<a href="https://wa.link/hvj3j6" target="_blank" class="whatsapp" style="color: #fff;text-decoration:none;"><img src="<?php echo esc_url('https://www.goodrxaustralia.com/wp-content/uploads/2023/05/whatsapp.png'); ?>" width="20" height="20" alt="whatsapp" /><span>+61 7 3103 2369 (Click to chat)</span></a>
												</p>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td valign="top" id="body_content">
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top">
                                                            <h2 id="site_title">
                                                            Goodrxaustralia.com <?php //echo $email_heading; ?>
